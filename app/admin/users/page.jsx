...
export default function UsersPage() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const response = await fetch("http://192.168.1.19:8080/api/admin/users", {
          method: "GET",
          headers: {
  ...
  useEffect(() => {
    const fetchPendingRequests = async () => {
      try {
        ...
        const response = await fetch("http://192.168.1.19:8080/api/user/admin-requests", {
          method: "GET",
          headers: {
            "Authorization": `Bearer ${token}`,
    ...
    const fetchRequestHistory = async () => {
      try {
        ...
        const response = await fetch("http://192.168.1.19:8080/api/user/admin-requests/history", {
          method: "GET",
          headers: {
            "Authorization": `Bearer ${token}`,
            "Content-Type": "application/json",
  ...
  const handleDelete = async (userId) => {
    try {
      ...
      const response = await fetch("http://192.168.1.19:8080/api/user/delete", {
        method: "POST",
        headers: {
          "Authorization": `Bearer ${token}`,
          "Content-Type": "application/json"
  ...
  const handleAddDealer = async () => {
    try {
      ...
      const response = await fetch("http://192.168.1.19:8080/api/user/dealer", {
        method: "POST",
        headers: {
          "Authorization": `Bearer ${token}`,
          "Content-Type": "application/json"
      ...
      // Refresh users list
      const fetchResponse = await fetch("http://192.168.1.19:8080/api/admin/users", {
        headers: {
          "Authorization": `Bearer ${token}`
        }
      })
  ...
  const handlePromoteToAdmin = async (userId) => {
    try {
      ...
      const response = await fetch(`http://192.168.1.19:8080/api/user/promote-to-admin/${userId}`, {
        method: "POST",
        headers: {
          "Authorization": `Bearer ${token}`
        }
  ...
  const handleDemoteToDealer = async (userId) => {
    try {
      ...
      const response = await fetch(`http://192.168.1.19:8080/api/user/demote-to-dealer/${userId}`, {
        method: "POST",
        headers: {
          "Authorization": `Bearer ${token}`
        }
  ...
  const handleStatusToggle = async (userId, currentStatus, targetStatus) => {
    try {
      ...
      const response = await fetch("http://192.168.1.19:8080/api/user/status", {
        method: "POST",
        headers: {
          "Authorization": `Bearer ${token}`,
          "Content-Type": "application/json"
  ...
  const handleApproveRequest = async (requestId) => {
    try {
      ...
      const response = await fetch(`http://192.168.1.19:8080/api/user/admin-requests/${requestId}/approve`, {
        method: "POST",
        headers: {
          "Authorization": `Bearer ${token}`,
          "Content-Type": "application/json"
      ...
      if (response.ok || result?.status === "APPROVED") {
        ...
        if (activeTab === "history") {
          const historyResponse = await fetch("http://192.168.1.19:8080/api/user/admin-requests/history", {
            headers: {
              "Authorization": `Bearer ${token}`,
              "Content-Type": "application/json"
            }
  ...
  const handleDenyRequest = async (requestId) => {
    try {
      ...
      const response = await fetch(`http://192.168.1.19:8080/api/user/admin-requests/${requestId}/deny`, {
        method: "POST",
        headers: {
          "Authorization": `Bearer ${token}`,
          "Content-Type": "application/json"
